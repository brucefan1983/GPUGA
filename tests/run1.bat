...
fc tests\si_diamond\ga.out tests\si_diamond\ga1.out
del tests\si_diamond\force.out
del tests\si_diamond\virial.out
del tests\si_diamond\energy.out
del tests\si_diamond\ga.out
